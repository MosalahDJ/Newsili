...
class ScienceData {
  ...
  Future<Database> get database async {
    ...
    _database = await _initDB('science_news.db');
    return _database!;
  }
  ...
  Future<void> insertNews(List<Map<String, dynamic>> articles) async {
    ...
    await db.transaction((txn) async {
      // Clear old data
      await txn.delete('science_news');

      // Insert new articles
      for (var article in articles) {
        await txn.insert('science_news', {
          ...article,
  ...
  Future<List<Map<String, dynamic>>> getNews() async {
    final db = await database;
    return await db.query('science_news', orderBy: 'timestamp DESC');
  }
